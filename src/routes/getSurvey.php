...
$app->post('/api/Freshdesk/getSurvey', function ($request, $response) {
    ...
    $url = "https://" . $postData['args']['domain'] . "." . $settings['apiUrl'] . "/tickets/" . $postData['args']['ticketId'] . "/satisfaction_ratings";
