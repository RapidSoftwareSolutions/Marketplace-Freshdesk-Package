...
$app->post('/api/Freshdesk/toggleTimer', function ($request, $response) {
    ...
    $url = "https://" . $postData['args']['domain'] . "." . $settings['apiUrl'] . "/time_entries/" . $postData['args']['timeEntryId'] . "/toggle_timer";
