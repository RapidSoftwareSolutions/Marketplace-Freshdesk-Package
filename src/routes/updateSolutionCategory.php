...
$app->post('/api/Freshdesk/updateSolutionCategory', function ($request, $response) {
    ...
    $url = "https://" . $postData['args']['domain'] . "." . $settings['apiUrl'] . "/solutions/categories/" . $postData['args']['categoryId'];
