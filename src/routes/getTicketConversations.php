...
$app->post('/api/Freshdesk/getTicketConversations', function ($request, $response) {
    ...
    $url = "https://" . $postData['args']['domain'] . "." . $settings['apiUrl'] . "/tickets/" . $postData['args']['ticketId'] . "/conversations";
