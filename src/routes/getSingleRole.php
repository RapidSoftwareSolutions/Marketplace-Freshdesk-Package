...
$app->post('/api/Freshdesk/getSingleRole', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'domain', 'roleId']);
    ...
    $url = "https://" . $postData['args']['domain'] . "." . $settings['apiUrl'] . "/roles/" . $postData['args']['roleId'];
