    ...
    try {
        ...
        if ($vendorResponse->getStatusCode() == 200) {
            ...
            $result['contextWrites']['to'] = [
                ...
                "info" => [
                    "X-Freshdesk-API-Version" => $vendorResponse->getHeader("X-Freshdesk-API-Version"),
                    "X-RateLimit-Remaining" => $vendorResponse->getHeader("X-RateLimit-Remaining"),
                    "X-RateLimit-Total" => $vendorResponse->getHeader("X-RateLimit-Total"),
                    "X-RateLimit-Used-CurrentRequest" => $vendorResponse->getHeader("X-RateLimit-Used-CurrentRequest")
                ]
            ];
        }
        else {
